...
export const fetchCurrentPlayers = () => {
  return {
    types: [LOAD, FETCH_PLAYERS_SUCCESS, FAIL],
...
export const addPlayer = ({ name, rating }) => {
  ...
  return {
    types: [LOAD, ADD_PLAYER_SUCCESS, FAIL],
    promise
  };
};
...
export const updatePlayer = ({ name, rating, id }) => {
  ...
  return {
    types: [LOAD, UPDATE_PLAYER_SUCCESS, FAIL],
    promise
  };
};
...
export const deletePlayer = (id) => {
  ...
  return {
    types: [LOAD, DELETE_PLAYER_SUCCESS, FAIL],
    promise
  };
};
